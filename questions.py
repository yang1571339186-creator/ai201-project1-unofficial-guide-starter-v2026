...
QUESTIONS = [
 # {"question": "...", "expects": "..."},
    ...
    {"question": "How long to walk around Brightwater end to end", "expects": "35 minutes"},
    ...
    {"question": "Best time of year to visit thornby well's gardens", "expects": "May and June"},
]
